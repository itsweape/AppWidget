...
public class NewAppWidget extends AppWidgetProvider {
    ...
    private static final String sharedPreffile = "com.example.appwidget";
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        //membaca sebuah count dari sharedpref
        SharedPreferences preferences = context.getSharedPreferences(sharedPreffile, 0);
        int count = preferences.getInt(COUNT_KEY+appWidgetId, 0); //sebagai pembeda counter widget satu dengan yg lain
        count++;
        views.setTextViewText(R.id.appwidget_count, String.valueOf(count));

        //menampilkan id widget
        ...
        //button click akan broadcast ke fungsi onUpdate dan dikembalikan ke intentUpdate
